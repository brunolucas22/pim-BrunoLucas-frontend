...
public class CurrencyWriterService {
	...
	private static CurrencyWriterService instance = null;
	
	public static CurrencyWriterService getInstance() {
		if (instance == null) {
			instance = new CurrencyWriterService();
		}

		return instance;
	}
	
	private CurrencyWriterService() {
